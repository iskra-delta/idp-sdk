...
unsigned char i;
    ...
    cprintf("Cursor position is x=%d,y=%d", wherex(), wherey());
    cprintf(" and screen size is x=%d,y=%d", ti.screenwidth, ti.screenheight);
    gotoxy(0, 3);
    wait("Press any key.");
